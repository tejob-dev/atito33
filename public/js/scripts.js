...
initIsotope();
    ...
    modal.hide = function () {
        if(modal.modalid != null){
            console.log(modal.modalid, modal.backmodalid, modal.overmodalid);
            $("#"+modal.backmodalid+", #"+modal.overmodalid).fadeOut(200);
            $("#"+modal.modalid).removeClass("vis_mr");
        }else{ 
    ...
    $('.modal-open').on("click", function (e) {
        ...
        var backmodalid =  $(e.target).data("backmodalid");
        var overmodalid =  $(e.target).data("overmodalid");
        if(modalid != null){
            $("#"+backmodalid+", #"+overmodalid).fadeIn(200);
            console.log(modalid);
            console.log(modalid, backmodalid, overmodalid);
            $("#"+modalid).addClass("vis_mr");
        }else{ 
            $('.modal , .reg-overlay').fadeIn(200);
            $(".modal_main").addClass("vis_mr");
        }
        modal.modalid = modalid;
        modal.backmodalid = backmodalid;
        modal.overmodalid = overmodalid;
        $("html, body").addClass("hid-body");
    });
